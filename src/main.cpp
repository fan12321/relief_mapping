...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int diffuseMap = loadTexture("../data/relief_colour_2.png");
    unsigned int normalMap  = loadTexture("../data/relief_normal_2.png");
    unsigned int heightMap  = loadTexture("../data/relief_height_2.png");
